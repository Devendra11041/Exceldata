		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comappimportexceldata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappimportexceldata-display": {
								"semanticObject": "comappimportexceldata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.importexceldata",
									"url": sap.ui.require.toUrl("com/app/importexceldata")
								}
							}
						}
					}
